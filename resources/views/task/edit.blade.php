                    ...
                    <form action="{{ route('task_edit', ['task_id' => $task->id]) }}" method="post">
                        ...
                        <div class="mb-3">
                            <div class="form-check form-check-inline">
                                <input type="radio" id="finish_flg1" name="finish_flg" class="form-check-input" value="0" {{ old('finish_flg', $task->finish_flg) == 0 ? 'checked' : '' }}>
                                <label for="finish_flg1" class="form-check-label">未完了</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" id="finish_flg2" name="finish_flg" class="form-check-input" value="1" {{ old('finish_flg', $task->finish_flg) == 1 ? 'checked' : '' }}>
